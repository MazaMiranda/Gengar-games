...
import { FloppyDisk, Key, ShieldWarning } from '@phosphor-icons/react/dist/ssr';
  ...
  return (
    <div className="flex flex-col gap-6">
      <form
        ...
        className="plate flex flex-col gap-6 rounded-xl p-6"
        noValidate
      >
        <h2 className="font-display text-ink text-sm font-bold">Dados cadastrais</h2>
      ...
      <section className="plate flex flex-col gap-5 rounded-xl p-6">
        <h2 className="font-display text-ink text-sm font-bold">Comunicação</h2>
          ...
          {PREFERENCES.map((preference, index) => (
            <React.Fragment key={preference.id}>
              ...
              <label className="flex cursor-pointer items-center justify-between gap-6 py-3.5">
                <span className="text-ink-muted text-sm">{preference.label}</span>
      ...
      <section className="plate flex flex-col gap-5 rounded-xl p-6">
        <h2 className="font-display text-ink text-sm font-bold">Segurança</h2>
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-ink text-sm font-semibold">Senha</p>
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <span className="border-danger/25 bg-danger/8 text-danger grid size-9 place-items-center rounded-md border">
              <ShieldWarning className="size-4" />
            </span>
            <div>
              <p className="text-ink text-sm font-semibold">Excluir conta</p>
          ...
          <Button
            variant="outline"
            size="sm"
            className="text-danger hover:border-danger/50 hover:bg-danger/8"
          >
            Excluir
          </Button>
        </div>
