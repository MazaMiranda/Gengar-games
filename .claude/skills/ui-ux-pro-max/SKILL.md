...
O script mora dentro da própria skill, versionado junto com o projeto. Os caminhos abaixo são relativos à raiz do repositório (`Gengar-games/`) — rode a partir dela, ou troque o prefixo pelo caminho absoluto da raiz:
